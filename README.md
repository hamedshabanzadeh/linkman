...
هدف این پروژه ایجاد یک صفحه ساده، سریع و مستقل برای جایگزینی سرویس‌های Link in Bio است.
 ...
 افراد با ورود به صفحه linkman می‌تواند از یک نقطه به راه‌های مختلف ارتباطی و پروفایل‌های کاربر دسترسی داشته باشد؛ از ایمیل و پیام‌رسان‌ها تا شبکه‌های اجتماعی، GitHub و Apple Music.
