...
کاربر با ورود به صفحه linkman می‌تواند از یک نقطه به راه‌های مختلف ارتباطی و پروفایل‌های افراد دسترسی داشته باشد؛ از ایمیل و پیام‌رسان‌ها تا شبکه‌های اجتماعی، GitHub و Apple Music.
...
طراحی و توسعه توسط **[حامد شعبان‌زاده](https://hamedshabanzadeh.github.io/linkman/)** با کمک ابزارهای کلاد و چت‌جی‌پی‌تی انجام شده است.
