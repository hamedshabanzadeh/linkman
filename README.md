...
کاربر با ورود به صفحه linkman می‌تواند از یک نقطه به راه‌های مختلف ارتباطی و پروفایل‌های فرد دسترسی داشته باشد؛ از ایمیل و پیام‌رسان‌ها تا شبکه‌های اجتماعی، GitHub و Apple Music.
